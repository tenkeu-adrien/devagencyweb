...
export const metadata = {
  title: "À propos | Dev Agency",
  description:
    "Dev Agency est une agence digitale spécialisée dans la création de sites web, le développement d'applications web et mobiles.",
};
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
              <div className="text-white">
                ...
                <p className="text-xl mb-8">
                  Depuis 2021, nous propulsons la croissance digitale des entreprises en
                  créant des solutions sur mesure : sites web modernes, applications
                  performantes et interfaces intuitives.
                </p>
          ...
          <div className="bg-white rounded-xl shadow-lg overflow-hidden">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 p-8">
              <div className="space-y-6">
                ...
                <p>
                  Dev Agency accompagne les entreprises, startups et entrepreneurs dans
                  leur digitalisation en concevant des solutions modernes, évolutives et
                  optimisées pour le référencement.
                </p>

                <h3 className="text-xl font-semibold text-gray-800">
                  Nos domaines d&rsquo;expertise
                </h3>
                <ul className="space-y-3">
                  ...
                  <li className="flex items-start">
                    ...
                    <span>Développement d&rsquo;applications web et mobiles sur mesure</span>
                  </li>
                  <li className="flex items-start">
          ...
          <div className="bg-white rounded-xl shadow-lg overflow-hidden">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 p-8">
              ...
              <div className="space-y-6">
                ...
                <p>
                  Nos développeurs, designers et chefs de projet travaillent en synergie
                  pour livrer des produits à forte valeur ajoutée, optimisés pour le SEO,
                  l&rsquo;expérience utilisateur et les performances techniques.
                </p>
